...
class Client {
    ...
    setRank(rank) {
        ...
        this.rank = rank;
        let rankName = getRank(rank).fullName;

        var pixelBucket = ranks[rankName.toLowerCase()].placeBucket.split("x");
        var chatBucket = ranks[rankName.toLowerCase()].chatBucket.split("x");
